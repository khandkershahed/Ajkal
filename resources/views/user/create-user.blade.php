          ...
          >
            <div class="post d-flex flex-column-fluid" id="kt_post">
              <div id="kt_content_container" class="container-xxl">
                <h1 class="text-center pb-3 fs-1">User Create</h1>
                <div class="row">
                  <div class="col-lg-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="fv-row mb-5">
                              ...
                              <input class="form-control form-control-solid" name="phone" type="number" required />
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="fv-row mb-5">
                          ...
                          <div class="col-lg-12">
                            <div class="fv-row mb-5">
                              ...
                              <input class="form-control form-control-solid" name="address" required />
                            </div>
                          </div>
                        </div>
