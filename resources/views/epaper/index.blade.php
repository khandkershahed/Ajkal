                            ...
                            <tr class="odd">
                              ...
                              <td class="text-center">
                                <div class="d-flex justify-content-end flex-shrink-0">
                                  ...
                                  <button type="button" id="{{$epaper->epaper_date}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm epaper_delete_btn">
                                    <span class="svg-icon svg-icon-3">
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
