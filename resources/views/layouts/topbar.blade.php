                ...
                <div class="d-flex align-items-stretch" id="kt_header_nav">
                  <ol class="breadcrumb text-muted fs-6 fw-bold">
                    <li class="breadcrumb-item pe-3">
                      <a href="{{url('/dashboard')}}" class="pe-3">Dashboard</a>
                    </li>
                  </ol>
                </div>
                <div class="d-flex align-items-stretch flex-shrink-0">
                            ...
                            <div class="scroll-y mh-200px mh-lg-350px">
                              ...
                              >
                                <div class="symbol symbol-40px me-4">
                                  <img
                                    src="{{URL::asset('assets/media/avatars/300-6.jpg')}}"
                                    alt=""
                                  />
                                </div>
                                <div
                              ...
                              >
                                <div class="symbol symbol-40px me-4">
                                  <img
                                    src="{{URL::asset('assets/media/avatars/300-2.jpg')}}"
                                    alt=""
                                  />
                                </div>
                                <div
                              ...
                              >
                                <div class="symbol symbol-40px me-4">
                                  <img
                                    src="{{URL::asset('assets/media/avatars/300-9.jpg')}}"
                                    alt=""
                                  />
                                </div>
                                <div
                              ...
                              >
                                <div class="symbol symbol-40px me-4">
                                  <img
                                    src="{{URL::asset('assets/media/avatars/300-14.jpg')}}"
                                    alt=""
                                  />
                                </div>
                                <div
                              ...
                              >
                                <div class="symbol symbol-40px me-4">
                                  <img
                                    src="{{URL::asset('assets/media/avatars/300-11.jpg')}}"
                                    alt=""
                                  />
                                </div>
                                <div
                  ...
                  >
                    <div
                      ...
                      data-kt-menu-placement="bottom-end"
                    >
                      <img src="{{URL::asset('/images/profile.png')}}" alt="user" />
                    </div>
                    <div
                          ...
                          <div class="menu-item px-3">
                            ...
                            >
                              <span class="symbol symbol-20px me-4">
                                <img
                                  class="rounded-1"
                                  src="{{URL::asset('assets/media/flags/spain.svg')}}"
                                  alt=""
                                /> </span
                              >Spanish</a
                            >
                          ...
                          <div class="menu-item px-3">
                            ...
                            >
                              <span class="symbol symbol-20px me-4">
                                <img
                                  class="rounded-1"
                                  src="{{URL::asset('assets/media/flags/germany.svg')}}"
                                  alt=""
                                /> </span
                              >German</a
                            >
                          ...
                          <div class="menu-item px-3">
                            ...
                            >
                              <span class="symbol symbol-20px me-4">
                                <img
                                  class="rounded-1"
                                  src="{{URL::asset('assets/media/flags/japan.svg')}}"
                                  alt=""
                                /> </span
                              >Japanese</a
                            >
                          ...
                          <div class="menu-item px-3">
                            ...
                            >
                              <span class="symbol symbol-20px me-4">
                                <img
                                  class="rounded-1"
                                  src="{{URL::asset('assets/media/flags/france.svg')}}"
                                  alt=""
                                /> </span
                              >French</a
                            >
